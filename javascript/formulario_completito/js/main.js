...

{
    ...
    let init = function() {
        ...
        let rellenarCampos = function() {
            document.getElementById("nombre").value = "Paco";
            document.getElementById("edad").value = "30";
            document.getElementsByName("sexos")[0].checked = "true";
            document.getElementById("idioma").value = "espannol";
            document.getElementById("DNI").value = "12345678Z";
            document.getElementById("email").value = "prueba@gmail.com";
            document.getElementById("fechaNacimiento").value = "15/05/1990";
            document.getElementById("telefono").value = "111222333";
            document.getElementById("cuentaCorriente").value = "1111-1111-11-1111111111";
            document.getElementById("direccionWeb").value = "https://www.google.es";
